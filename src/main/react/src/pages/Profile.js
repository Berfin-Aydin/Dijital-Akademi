                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="userName" class="form-control" value={userName} required disabled />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="profile_details_text">Soyad: </label>
                                    <input type="text"  name="userSurname" class="form-control"value={userSurname} onChange={this.onChangeInput} required />
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="userEmailAddress" class="form-control" value={this.state.userEmailAddress} required onChange={this.onChangeInput}/>
                                    <div style={{ fontSize: 12, color: "red" }}>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <InputMask className="form-control " id="phone" name="userPhone" mask="(999) 999-9999" value={userPhone} placeholder="(999) 999-9999"  />
                                </div>
                            </div>
                        </div>
